        ...
        if bboxes:
            ...
            for d in trk_result:
                ...
                if joints_norm_per_frame.size > 0:
                    ...
                    print(init_label)
                    # 显示动作类别
                    if(init_label == "stand" or init_label == "falldown"):
    ...
    if bboxes:
        ...
        for d in trk_result:
            ...
            if joints_norm_per_frame.size > 0:
               ...
               # print(init_label)
                # 显示动作类别
                if(init_label == "stand" or init_label == "standd" or init_label == "falldown"):
                    cv.putText(frame, init_label, (xmin + 80, ymin - 45), cv.FONT_HERSHEY_SIMPLEX, 1, trk_clr, 3)
                    ...
                    if (init_label == 'falldown') and (send_msg == 0):
                        ...
                        if (init_label == 'falldown') and (send_msg == 1):
                            ...
                            print("dnsjkb") 
                    elif init_label=='stand' or init_label=='sucide' or init_label=='eat':
                        send_msg=0         
            cv.rectangle(frame, (xmin - 10, ymin - 30), (xmax + 10, ymax), trk_clr, 2)
            #print(init_label)
